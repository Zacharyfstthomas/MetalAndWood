...
# File paths  
# Configuration
frame_path = "./Hamill/1117P/11x17_Empty_frame_PNG_Alt.png"  # Your frame image
designs_folder = "./Hamill/1117P"  # Folder containing design images
output_folder = "./Hamill/1117P/Framed"
frame_box = (17, 15, 471, 716)   # (left, top, right, bottom) coordinates of the frame area
